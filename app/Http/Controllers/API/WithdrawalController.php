...
class WithdrawalController extends Controller
{
    public function myWalletInfo(){
        try {
            ...
            if (!$info) {
                return $this->errorResponse('User wallet data not found.',null,Response::HTTP_CONFLICT);
            }
    ...
    public function tokenConvert(Request $request)
    {
        ...
        try {
            ...
            if ($info->earn_token < $request->token) {
                return $this->errorResponse('Insufficient earn token to convert.',null,Response::HTTP_UNPROCESSABLE_ENTITY);
            }
